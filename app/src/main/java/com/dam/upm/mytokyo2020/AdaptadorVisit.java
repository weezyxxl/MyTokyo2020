 ...
 */
public class AdaptadorVisit
        extends RecyclerView.Adapter<AdaptadorVisit.ViewHolder> {

    private static Context mContext;
    private static CustomItemClickListener listener;
    ArrayList<Experiencia> data;


    public AdaptadorVisit(Context mContext, ArrayList<Experiencia> data, CustomItemClickListener listener) {
    ...
    public int getItemCount() {
        return Experiencia.Experiencias.size();
    }
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        Experiencia item = Experiencia.Experiencias.get(i);
